...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <column label="用户名" name="user" type="String" xid="xid7"></column>
  ...
  <div class="x-scroll userComment" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView_userComment" onPullDown="scrollView_userCommentPullDown" onPullUp="scrollView_userCommentPullUp">
   ...
   <div component="$UI/system/components/justep/output/output" class="x-output x-edit teacher" xid="output_teacher" bind-ref='$model.course.ref("teachers")'></div></div>
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit_classify">
   ...
   <div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output_classify" bind-ref='$model.course.ref("typeName")'></div></div>
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit_time">
   ...
   <div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output_time" bind-ref='$model.course.ref("classhour")'></div></div>
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit_schedule">
   ...
   <div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output_schedule" bind-ref='$model.course.ref("times")'></div></div>
  </div>
  <div xid="div_right" class="div_right">
  
  
  <div xid="div_click" class="x-label-edit x-label30"><label xid="label_click"><![CDATA[点击]]></label><div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output_click" bind-ref='$model.course.ref("clicks")'></div></div>
  <div xid="div_comment" class="x-label-edit x-label30"><label xid="label_comment"><![CDATA[评论]]></label><div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output_comment" bind-ref='$model.course.ref("speaks")'></div></div>
  <div xid="div_ask" class="x-label-edit x-label30"><label xid="label_ask"><![CDATA[申请]]></label><div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output_ask" bind-ref='$model.course.ref("users")'></div></div>
  <div xid="div_xuexi" class="x-label-edit x-label30"><label xid="label_xuexi"><![CDATA[学习]]></label><div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output_xuexi" bind-ref='$model.course.ref("learns")'></div></div>
  <div xid="div_wanchen" class="x-label-edit x-label30"><label xid="label_wanchen"><![CDATA[完成]]></label><div component="$UI/system/components/justep/output/output" class="x-output x-edit" xid="output_wanchen" bind-ref='$model.course.ref("completes")'></div></div>
...
<div xid="div_courseInfo" class="courseInfo"><label xid="label_courseInfo"><![CDATA[课程简介]]></label>
  ...
  <div xid="div_userComment" class=" x-scroll-view comm_title"><label xid="label_userComment"><![CDATA[学员评论]]></label>
   ...
   <div class="media-left" xid="mediaLeft_userComment">
    <img src="img/user_pic.png" alt="" xid="image_userComment_icon" bind-attr-src=' val("image")'></img></div> 
   <div class="media-body" xid="mediaBody_userComment">
    <div xid="div_userComment_head" class="media_head"><div component="$UI/system/components/justep/output/output" class="x-output user" xid="output_comment_user" bind-ref='ref("id")'></div>
