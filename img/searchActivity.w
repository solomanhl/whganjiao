...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <column name="cdate" type="String" xid="xid6"></column></div></div>  
  <div component="$UI/system/components/justep/panel/panel" 
   ...
   <span xid="span1">搜索</span></a></div>
    ...
    <div class="x-panel-content  x-scroll-view" xid="content1" _xid="C74A53BD95D00001501675401E02ADB0" style="bottom: 0px;"><div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView1">
      <div class="search_bg"><img src="img/search_bg.jpg" alt=""/></div>
   
   <div class="x-scroll-content" xid="div2"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="study_course">
   ...
   <div class="media-body" xid="mediaBody1">
    <div component="$UI/system/components/justep/output/output" class="x-output" xid="output_title" bind-ref='ref("name")'></div>
  <div xid="div5"><label xid="label2"><![CDATA[讲师：]]></label>
  <div component="$UI/system/components/justep/output/output" class="x-output" xid="output_teacher" bind-ref='ref("teachers")'></div></div>
  <div xid="div6"><label xid="label3"><![CDATA[选课人数：]]></label>
  <div component="$UI/system/components/justep/output/output" class="x-output" xid="output_count" bind-ref='ref("users")'></div></div></div> </div></li></ul> </div></div>
   </div></div>
  </div> 
</div>