...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    ...
    <div class="x-panel-content" xid="content1"><iframe src="" xid="iframe1" height="100%" width="100%"></iframe></div>
  </div> 
<span component="$UI/system/components/justep/timer/timer" xid="timer1" interval="120000" onTimer="timer1Timer"></span>
