...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <column label="考试获得学时 float" name="examcredithour" type="String" xid="xid6"></column>
  ...
  <column label="完成调查问卷" name="pollFinished" type="String" xid="xid5"></column>
  <column label="完成问卷学时" name="pollcredithour" type="String" xid="xid15"></column></div>
  </div>  
  ...
  <div xid="div_xuexi" class="same"><label xid="label1"><![CDATA[学习课件获得学时]]></label><div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true" responsive="true" rowActiveClass="active" class="table table-hover table-striped" xid="dataTables1" data="dangan">
   <columns xid="columns1"><column name="courseJoined" xid="column3" label="选择" orderable="false"></column>
  <column name="courseFinished" xid="column2" label="完成" orderable="false"></column>
  <column name="times" xid="column1" label="学时" orderable="false"></column>
  </columns></div>
  </div>
